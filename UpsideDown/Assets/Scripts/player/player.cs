...
//         GenerateAccelerationCurve(50, speed*4, speed/5);
...
//         }else{
//             if(wallClimbGraceTimer > 0.0f){// && latest_activation == "right"){ // left wall jump
//                 animator.SetBool("isJumping", true);
//                 soundManager.PlayJumpSound();
//                 Debug.Log("Jump left wall");
//                 rb.AddForce(new Vector2(speedJump*0.2f, speedJump*1.0f), ForceMode2D.Impulse);
//                 wallClimbTimout = 10.0f;
//                 wallClimbReady[0] = false; 
//                 wallClimbGraceTimer = 0;
//             }
//             if(wallClimbGraceTimer > 0.0f){// && latest_activation == "left"){ // right wall jump
//                 animator.SetBool("isJumping", true);
//                 soundManager.PlayJumpSound();
